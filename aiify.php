    ...
    if (!defined('AIIFY_OPEN_AI_KEY') || AIIFY_OPEN_AI_KEY == '') {
        ...
        add_action('admin_notices', function () {
    		...
    		<div class="error notice">
		        <p><?php echo esc_html__('To start using AIIFY Blocks, please setup you OpenAi Key', 'aiify') ;?><br/>
		        	<a href="<?php echo esc_url(admin_url('admin.php?page=aiify&welcome-message=true'))  ?>"  ><?php echo esc_html__('Go to Aiify Blocks settings', 'aiify') ;?></a>
		        </p>
		    </div>
    	<?php
        });
